            ...
            <div className='row align-items-center justify-content-center'>
                <div className='col-sm-'>
                    <div className="text-left">
                        ...
                        <img src={americanbulldog} className='img-fluid w-50' alt="" ></img>
                        <p>
                        ...
                        <p>
                            <ul>
                                <li>The Bully American Bulldogs is a short haired, heavy muscled dog.</li>
                                <li>A well bred Bully American Bulldog should have a compact sturdy frame. They should exude strength, health and function. The males are more masculine in appearance then the females.</li>
                                <li>Temparament:  American Bulldogs should be alert, outgoing and confident. Aloofness with strangers is acceptable. An American Bulldog may show dominance/assertiveness towards other dogs, however dogs may be dismissed at the judge’s discretion for disrupting their class. A dog showing weak nerves or showing to be overly aggressive will be excused from the confirmation ring. Dismissal is at the Judge’s discretion ONLY!</li>
                            </ul>
