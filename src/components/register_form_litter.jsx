...
class RegisterFormLitter extends Component {
...
{/*             
                ...
                <div className='form-row'>
                    <p className='text-white'>Litter Information</p>
                    <div class="form-group col-md-">
                        <label for="inputName">Breed</label>
                     ...
                     <div class="form-group col-md-">
                        <label for="inputDate">Today's Date</label>
                    ...
                    <div class="form-group col-md-">
                        <label for="inputDate">Date of Breeding</label>
                        <input name='date_of_birth' value={this.props.dog.sex} onChange={this.props.handleChange} 
                        class="form-date" type="date" id="Date"></input>
                    </div>
                    <div class="form-group col-md-">
                        <label for="inputName">Litter Date of Birth</label>
                        <input name='name' value={this.props.dog.name} type='date' onChange={this.props.handleChange}  class="form-control" id="inputName" placeholder="Registration Name of Dog"></input>
                    </div>
                    <div class="form-group col-md-">
                        <label for="inputName">Number to be Registered(Male)</label>
                        <input name='kennel_name' value={this.props.dog.kennel_name} onChange={this.props.handleChange}
                         type="number" class="form-control" id="inputName" placeholder="Kennel Name"></input>
                    
                    </div>
                    <div class="form-group col-md-">
                        <label for="inputName">Number to be Registered(Female)</label>
                        <input name='kennel_name' value={this.props.dog.kennel_name} onChange={this.props.handleChange}
                         type="number" class="form-control" id="inputName" placeholder="Kennel Name"></input>
                    
                    </div>
                    <div class="form-group col-md-">
                        <label for="inputName">Total Puppies)</label>
                        <input name='kennel_name' value={this.props.dog.kennel_name} onChange={this.props.handleChange}
                         type="number" class="form-control" id="inputName" placeholder="Kennel Name"></input>
...
export const SignUpForm = () => {
    ...
    export default RegisterFormLitter;
