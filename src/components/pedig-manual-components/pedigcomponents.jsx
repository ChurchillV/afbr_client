...
export class PedigWrapper extends React.Component{
...
export class PedigSireFirstGen extends React.Component {
        ...
        return (
            <div className="row align-items-center justify-content-center">
                <div className="col-sm-6">
                    ...
                    <Dog_registrations to_dams_first={true} to_sires_sires_firstgen={true} />
                </div>
                <div className="col-sm-6">
                    <div>
                        Dam of Sire
                    </div>
                    <Dog_registrations to_sires_dams_firstgen={true} />
                </div>
...
export class PedigDamFirstGen extends React.Component {
        ...
        return (
            <div className="row align-items-center pedigmain_full justify-content-center">
                <div className="col-sm-6">
                    ...
                    <Dog_registrations to_sires_first={true}
                        to_dams_sires_firstgen={true} />
                </div>
                <div className="col-sm-6">
                    <div>
                        Dam of dam
                    </div>
                    <Dog_registrations to_dams_dams_firstgen={true} />
                </div>
